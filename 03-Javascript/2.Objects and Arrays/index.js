...
let ansArray = arr1.map((number) =>{  // arr1 se ek ek element map function mejayega fir map me jo logic likha hoga usspr operation hoga fir wo return krega arr.map() funciton ko then uska value st.ore ho rha hai ansArray me 
